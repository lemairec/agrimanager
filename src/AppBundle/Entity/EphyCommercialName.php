 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\EphyCommercialNameRepository")
 */
class EphyCommercialName
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\EphyProduit", inversedBy="commercialeNames")

 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\InterventionProduitRepository")
 */
class InterventionProduit
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Intervention", inversedBy="produits")

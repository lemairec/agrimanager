...
class InterventionProduitRepository extends \Doctrine\ORM\EntityRepository
{
    function save($intervention_produit, $campagne){
        ...
        $produit = $em->getRepository('AppBundle:Produit')->findOrCreate($intervention_produit->name, $campagne);
        ...
        $em->flush();
        $produit = $em->getRepository('AppBundle:Produit')->update($produit);
        return $produit;
    }
    ...
    function delete($intervention_produit_id){
        ...
        $produit = $em->getRepository('AppBundle:Produit')->update($intervention_produit->produit);

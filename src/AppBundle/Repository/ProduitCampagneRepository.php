...
use AppBundle\Entity\ProduitCampagne;
...
class ProduitCampagneRepository extends \Doctrine\ORM\EntityRepository
{
    public function update($produit){
        ...
        $campagnes = $em->getRepository('AppBundle:Campagne')->findByCompany($produit->company);
        foreach($campagnes as $campagne){
            $achats = $em->getRepository('AppBundle:Achat')->createQueryBuilder('a')
                ->where('a.campagne = :campagne')
                ->andWhere('a.produit = :produit')
                ->setParameter('campagne', $campagne)
                ->setParameter('produit', $produit)
                ->getQuery()->getResult();
            $qty2 = $em->getRepository('AppBundle:InterventionProduit')->createQueryBuilder('a')

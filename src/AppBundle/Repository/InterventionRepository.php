...
class InterventionRepository extends \Doctrine\ORM\EntityRepository
{
    function delete($intervention_id){
        ...
        $intervention_parcelles = $em->getRepository('AppBundle:InterventionParcelle')
                                   ->findBy(array('intervention'=>$intervention));
        $intervention_produits = $em->getRepository('AppBundle:InterventionProduit')
                                   ->findBy(array('intervention'=>$intervention));
        foreach ($intervention_produits as $it) {
            $em->getRepository('AppBundle:InterventionProduit')->delete($it->id);
        }
